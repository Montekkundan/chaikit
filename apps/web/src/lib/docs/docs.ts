...
import { getDocTypeFromSlug } from "@/lib/utils/docs";
import type { Doc, DocCategory, DocFrontmatter, DocMetadata, DocType } from "@/types/docs";
import { getTableOfContents } from "@/lib/utils/toc";
...
// getDocs("components/chai") returns all docs from content/components/chai folder
